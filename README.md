...
1. [Download](https://github.com/EntusiastadomacOS/BASE-EFI-INTEL-DESKTOP-11THGEN-ROCKET-LAKE-OpenCore-0.8.9/releases) the latest release;
...
SMBIOS|Description
:----|:----
MacPro7,1|Because GPU integrated in 11th gen without support for Apple.
iMacPro1,1|Because GPU integrated in 11th gen without support for Apple.
